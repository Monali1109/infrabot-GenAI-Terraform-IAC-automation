resource "google_service_account" "app" {
  account_id   = "sa-gcp-app-test"
  display_name = "App Service Account - TEST"
  description  = "Service account for app servers in test"
}
...
resource "google_service_account" "db" {
  account_id   = "sa-gcp-db-test"
  display_name = "DB Service Account - TEST"
  description  = "Service account for DB servers in test"
}
