# VPC -> Your VPCs -> search Name = "VPC_AWS_TEST-01"
vpc_id            = "vpc-REPLACE_AFTER_VPC_DEPLOY"

# EC2 -> Security Groups -> search Name = "SG_AWS_APP_TEST-01"
security_group_id = "sg-REPLACE_AFTER_FIREWALL_DEPLOY"

# EC2 -> Subnets -> Names: "SUBNET_AWS_APP_TEST-01" and "SUBNET_AWS_DB_TEST-01"
